...
FS.DieseFarbeAuswaehlen = function(input){
	...
	$(input).value = farbe;
	if(input === "PatternContainer_FarbeAendernInput"){
		CB.Pattern.ValueAendern(input, 1);
	} else if(input === "FarbenContainer_ValueAendernInput"){
		CB.Farben.ValueAendern(input, 1);
	}
